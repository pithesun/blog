        ...
        <div className={rowRight}>
          <WorkExperienceRow
            ...
            issueList={[
              ...
              "단순 DB조회 데이터가 아닌 최적화와 캐싱된 설명서 이미지를 제공하는 API가 필요하여 프론트의 캐싱/최적화 로직을 재사용할 수 있도록 프론트에서 Nextjs의 API 라우트 기능을 사용하여 기능개발",
            ]}
            didlist={[
              "API 호출부에서는 상품코드로만 설명서의 최적화된 이미지 url을 알 수 있어, 타 개발자가 예상트래픽 조회 보고서를 작성하는 기능 개발 시 상품상세의 설명서 로직을 모르고도 간단히 개발가능할 수 있도록 기여함.",
            ]}
          ...
          <WorkExperienceRow
            ...
            issueList={[
              "웹뷰 환경에서 영상 재생 여부, 페이지 이탈여부에 맞춰서 미디어 세션 API와 웹 API를 이용하여 실시간 시청자 수 집계 API 요청을 중복/누락 없이 호출함",
